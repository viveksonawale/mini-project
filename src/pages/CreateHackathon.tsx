  ...
  const handlePublish = async () => {
    try {
      await hackathonService.createHackathon({
        ...
        prizePool: Number(String(form.prizePool).replace(/[^\d.]/g, "")),
      ...
      toast({ title: "Creation failed", description: e instanceof Error ? e.message : "Please retry", variant: "destructive" });
    }
  };
